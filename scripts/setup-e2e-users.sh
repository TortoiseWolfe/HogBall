...
if ! docker compose ps hogball | grep -q "Up"; then
    echo "❌ Error: Docker container 'hogball' is not running"
...
echo ""
echo "Run E2E tests:"
echo "  docker compose exec hogball pnpm exec playwright test tests/e2e/messaging/"
echo ""
