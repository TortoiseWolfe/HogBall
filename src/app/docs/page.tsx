...
export const metadata: Metadata = {
  title: 'Documentation - HogBall',
  description:
    'Comprehensive documentation for HogBall - Modern Next.js template with PWA, testing, and more.',
};
  ...
  const docSections = [
    {
      ...
      links: [
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/README.md',
          label: 'README',
          external: true,
        },
        {
          href: '/blog/hogball-intro',
          label: 'Introduction to HogBall',
          external: false,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall#quick-start',
          label: 'Quick Start',
          external: true,
        },
      ],
    },
    {
      ...
      links: [
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/CLAUDE.md',
        ...
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/FORKING-GUIDE.md',
          label: 'Forking Guide',
          external: true,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/CREATING_COMPONENTS.md',
    ...
    },
    {
      ...
      links: [
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/project/TESTING.md',
          label: 'Testing Strategy',
          external: true,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/ACCESSIBILITY.md',
          label: 'Accessibility Guide',
          external: true,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/PWA.md',
    ...
    },
    {
      ...
      links: [
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/PRP-EXECUTION-GUIDE.md',
          label: 'PRP Workflow',
          external: true,
        },
        {
        ...
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/tree/main/docs/spec-kit',
    ...
    },
    {
      ...
      links: [
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/project/CHANGELOG.md',
          label: 'Changelog',
          external: true,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/project/CONTRIBUTING.md',
          label: 'Contributing Guide',
          external: true,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/project/SECURITY.md',
          label: 'Security Policy',
          external: true,
        },
        {
          href: 'https://github.com/TortoiseWolfe/HogBall/blob/main/docs/project/SPRINT-4-ROADMAP.md',
    ...
    },
    {
      ...
      links: [
        {
          href: 'https://github.com/TortoiseWolfe/HogBall',
    ...
    <main className="container mx-auto px-4 py-6 sm:px-6 sm:py-8 md:py-12 lg:px-8">
      <header className="mb-8 text-center sm:mb-10 md:mb-12">
        <p className="text-base-content/70 text-base sm:text-lg md:text-xl">
          Everything you need to know about HogBall
        </p>
      </header>
      ...
      <section className="card bg-primary/10 mt-12">
        <div className="card-body">
          ...
          <div className="flex flex-wrap gap-4">
            <a
              href="https://github.com/TortoiseWolfe/HogBall/issues"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://github.com/TortoiseWolfe/HogBall/discussions"
              target="_blank"
              rel="noopener noreferrer"
