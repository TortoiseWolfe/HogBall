      ...
      try {
        ...
        if (response.ok) {
          ...
          const scores = {
            ...
            url: staticData.url || 'https://hogball.com/',
            isDefault: false,
          };
                  ...
                  <div className="alert alert-info mb-4 max-w-full">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-xs break-words">
                        ...
                        visit{' '}
                        <a
                          href="https://pagespeed.web.dev/?url=https://hogball.com/"
                          target="_blank"
                          rel="noopener noreferrer"
          ...
          title={
            <div className="flex items-center gap-2">
              ...
              <InfoTooltip
                ...
                learnMore="https://github.com/TortoiseWolfe/HogBall/blob/main/README.md"
              />
            </div>
          }
          bordered
