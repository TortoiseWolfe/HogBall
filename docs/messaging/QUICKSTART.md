...
docker compose exec hogball pnpm exec supabase db diff
...
docker compose exec hogball pnpm test src/lib/messaging/__tests__/
...
docker compose exec hogball pnpm test tests/integration/messaging/
...
- **GitHub Issues**: https://github.com/TortoiseWolfe/HogBall/issues
- **Supabase Discord**: https://discord.supabase.com
- **HogBall Discussions**: https://github.com/TortoiseWolfe/HogBall/discussions
