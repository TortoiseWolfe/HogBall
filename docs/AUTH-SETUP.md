...
| Field                          | Value                                                        |
| ------------------------------ | ------------------------------------------------------------ |
| **Application name**           | `HogBall` (or your preferred name)                      |
...
- **Production:** Your deployed URL (e.g., `https://hogball.github.io/HogBall`)

**Step 3:** Add Redirect URLs

- Click **"Add redirect URL"** for each environment:
  - `http://localhost:3000/**` (development)
  - `https://hogball.github.io/HogBall/**` (production)
