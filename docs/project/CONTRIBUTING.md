...
docker compose exec hogball pnpm dev       # Dev server
docker compose exec hogball pnpm test      # Run tests
docker compose exec hogball pnpm lint      # Run linting
docker compose exec hogball pnpm format    # Format code
docker compose exec hogball pnpm storybook  # Storybook
docker compose exec hogball pnpm type-check # TypeScript
```
...
| Script                                                | Description                      |
| ----------------------------------------------------- | -------------------------------- |
| `docker compose exec hogball pnpm dev`           | Start Next.js development server |
| `docker compose exec hogball pnpm build`         | Build for production             |
| `docker compose exec hogball pnpm test`          | Run Vitest tests                 |
| `docker compose exec hogball pnpm test:coverage` | Generate coverage report         |
| `docker compose exec hogball pnpm lint`          | Run ESLint                       |
| `docker compose exec hogball pnpm format`        | Format code with Prettier        |
| `docker compose exec hogball pnpm format:check`  | Check formatting without changes |
| `docker compose exec hogball pnpm type-check`    | Run TypeScript type checking     |
| `docker compose exec hogball pnpm storybook`     | Start Storybook development      |
...
docker compose exec hogball pnpm test:watch

# Generate coverage report
docker compose exec hogball pnpm test:coverage
```
...
- Review [existing issues](https://github.com/TortoiseWolfe/HogBall/issues)
- Ask in discussions
