...
docker compose exec hogball pnpm exec pa11y http://localhost:3000/messages --runner axe
docker compose exec hogball pnpm exec pa11y http://localhost:3000/messages/connections --runner axe
docker compose exec hogball pnpm exec pa11y http://localhost:3000/conversations --runner axe
```
...
docker compose exec hogball pnpm exec serve out -p 3000

# Terminal 3: Run Lighthouse
docker compose exec hogball pnpm exec lighthouse http://localhost:3000/messages \
...
# Analyze bundle
docker compose exec hogball pnpm exec next build --experimental-build-mode=compile
docker compose exec hogball ls -lh .next/static/chunks
```
...
2. Re-run build: `docker compose exec hogball pnpm run build`
