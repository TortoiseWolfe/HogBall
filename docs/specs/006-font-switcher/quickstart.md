...
docker compose exec hogball pnpm dev
```
...
```bash
docker compose exec hogball pnpm test FontSwitcher
# Test fails ❌
```
...
# Run Storybook
docker compose exec hogball pnpm storybook

# Build for production
docker compose exec hogball pnpm build

# Lint and format
docker compose exec hogball pnpm lint
docker compose exec hogball pnpm format
```
