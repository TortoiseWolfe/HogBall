...
docker compose exec hogball pnpm run generate:component -- --name ComponentName --category atomic --hasProps true

# Testing (TDD workflow)
docker compose exec hogball pnpm test                    # Run all tests
docker compose exec hogball pnpm test:coverage           # Coverage report
docker compose exec hogball pnpm exec playwright test    # E2E tests
docker compose exec hogball pnpm run test:a11y:dev       # Accessibility tests

# Code quality
docker compose exec hogball pnpm run type-check          # TypeScript validation
docker compose exec hogball pnpm run lint                # ESLint
docker compose exec hogball pnpm run test:suite          # Full test suite
