...
docker compose exec hogball pnpm list tailwindcss  # Verify 4.1.13
docker compose exec hogball pnpm list sharp  # Verify 0.34.4
```
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/types/mobile-first.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/config/breakpoints.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/config/test-viewports.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/config/touch-targets.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-navigation.spec.ts`
...
docker compose exec hogball pnpm exec playwright test e2e/tests/mobile-navigation.spec.ts
```
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-touch-targets.spec.ts`
...
docker compose exec hogball pnpm exec playwright test e2e/tests/mobile-touch-targets.spec.ts
```
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-horizontal-scroll.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-typography.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-orientation.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/blog-mobile-ux.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-card-layout.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-buttons.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-form-inputs.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-images.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/e2e/tests/mobile-footer.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/tailwind.config.ts`
...
```bash
docker compose restart hogball
docker compose logs hogball | grep -i error  # Should be none
```
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/styles/globals.css`
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/styles/mobile-first-utilities.css`
...
**File**: `/home/turtle_wolfe/repos/HogBall/playwright.config.ts`
...
**File**: `/home/turtle_wolfe/repos/HogBall/scripts/validate-breakpoints.js`
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/hooks/useDeviceType.ts`
...
```bash
docker compose exec hogball pnpm test src/hooks/useDeviceType.test.ts
```
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/components/GlobalNav.tsx`
...
**File**: `/home/turtle_wolfe/repos/HogBall/src/app/page.tsx`
...
**File**: `/home/turtle_wolfe/repos/HogBall/scripts/optimize-images.js`
...
```bash
docker compose exec hogball node scripts/optimize-images.js
...
**File**: `/home/turtle_wolfe/repos/HogBall/CLAUDE.md`
...
**File**: `/home/turtle_wolfe/repos/HogBall/docs/MOBILE-FIRST-GUIDE.md`
...
**File**: `/home/turtle_wolfe/repos/HogBall/plop-templates/Component.tsx.hbs`
...
docker compose exec hogball pnpm exec playwright test --project="iPhone 12"
docker compose exec hogball pnpm run build
```
...
```bash
docker compose exec hogball npx lighthouse http://localhost:3000 --preset=mobile --output=html --output-path=./lighthouse-mobile.html
```
...
**File**: `/home/turtle_wolfe/repos/HogBall/docs/prp-docs/PRP-STATUS.md`
