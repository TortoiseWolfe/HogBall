...
- [x] T002 [P] Verify TypeScript compilation passes before changes: `docker compose exec hogball pnpm run type-check`
...
- [x] T012 [US2] Verify TypeScript compilation with new signature
  - Run: `docker compose exec hogball pnpm run type-check`
...
- [x] T016 [P] Run full type-check: `docker compose exec hogball pnpm run type-check`
- [ ] T017 [P] Run unit tests: `docker compose exec hogball pnpm test`
