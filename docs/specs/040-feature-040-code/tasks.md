...
```
Command: docker compose exec hogball pnpm test
...
```
Command: docker compose exec hogball pnpm test --coverage src/lib/logger/
...
```
Command: docker compose exec hogball pnpm run build
