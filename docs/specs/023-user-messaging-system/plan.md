...
**Input**: Feature specification from `/home/turtle_wolfe/repos/HogBall/specs/023-user-messaging-system/spec.md`
...
- Use component generator: `docker compose exec hogball pnpm run generate:component`
...
- Commands executed via: `docker compose exec hogball pnpm run <command>`
...
**Structure Decision**: Web application structure (Option 2) selected. HogBall uses Next.js App Router with:
...
All requirements align with HogBall constitution v1.0.1. No complexity exceptions needed.
