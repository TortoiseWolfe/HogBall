...
Analyze HogBall's existing patterns for Supabase integration, offline support, real-time subscriptions, and authentication to ensure the messaging system follows established conventions.
...
- Create `/home/turtle_wolfe/repos/HogBall/supabase/migrations/20251008_user_messaging_system.sql`
