...
docker compose exec hogball pnpm test src/utils/consent
docker compose exec hogball pnpm test src/contexts/Consent
docker compose exec hogball pnpm test src/components/privacy

# Run integration tests
docker compose exec hogball pnpm test src/tests/consent
