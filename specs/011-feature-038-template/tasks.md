...
- [x] T008 [US1] Implement previous-rebrand detection (grep for "HogBall" count)
...
- [x] T012 [US1] Implement file renaming for files containing "HogBall" in name
...
**Independent Test**: Run `docker compose exec hogball git commit -m "test"` after change
