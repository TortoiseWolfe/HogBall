...
Research into the HogBall codebase reveals a well-architected project auto-detection system already in place. The main gaps are:
...
| -------------- | --------------------------- | ------------------------------------- |
| Service Worker | `public/sw.js:4`            | Hardcoded `hogball-v1.0.0` cache |
...
- Service name `hogball` is hardcoded
...
4. Renames files containing "HogBall"
