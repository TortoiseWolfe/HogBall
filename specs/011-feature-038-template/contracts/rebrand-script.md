...
| 0    | Success                                                    |
| 1    | Invalid arguments                                          |
| 2    | Re-rebrand scenario (no HogBall found), user declined |
| 3    | Git not installed or not a git repo                        |

## Output Format

```
Rebranding HogBall → MyApp
Owner: myuser
...
Renaming files...
  ✓ HogBallLogo.tsx → MyAppLogo.tsx
  ✓ LayeredHogBallLogo.tsx → LayeredMyAppLogo.tsx
...
If grep finds 0 occurrences of "HogBall":

```
WARNING: This repository appears to have been rebranded already.
No "HogBall" references found.
