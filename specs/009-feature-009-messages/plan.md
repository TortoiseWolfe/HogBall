...
docker compose exec hogball pnpm run type-check  # No any type errors
docker compose exec hogball pnpm run lint        # No ESLint warnings
docker compose exec hogball pnpm test            # All tests pass

# Final verification
docker compose exec hogball pnpm run build       # Production build clean
```
...
| SC-006: A11y passes            | `docker compose exec hogball pnpm run test:a11y`                       |
