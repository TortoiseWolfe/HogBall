...
- [x] T001 Run `docker compose exec hogball pnpm run type-check` and record current state
- [x] T002 [P] Run `docker compose exec hogball pnpm run lint` and record current warnings
...
- `docker compose exec hogball pnpm run test:a11y` passes
