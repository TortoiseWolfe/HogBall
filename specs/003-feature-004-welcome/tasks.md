...
- [x] T019 [US1] Run tests: `docker compose exec hogball pnpm test welcome-service`

- [x] T020 [US1] Manual verification: Sign up new user, check conversations for welcome message from hogball
...
- [x] T033 [POLISH] Run full test suite: `docker compose exec hogball pnpm test`

- [x] T034 [POLISH] Run type check: `docker compose exec hogball pnpm type-check`

- [x] T035 [POLISH] Run linter: `docker compose exec hogball pnpm lint`
